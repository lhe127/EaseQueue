...
<body onload="setInitialStatus()">
        ...
        <div class="fixed bg-white text-blue-800 px-10 py-1 z-10 w-full">
            <div class="flex items-center justify-between py-2 text-5x1">
                ...
                <div class="flex items-center text-gray-500">
                    ...
                    <form id="statusForm" action="/update-status" method="POST" style="display: none;">
                        @csrf
            ...
            <div class="w-2/12 mr-6">
                ...
                <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
                    <a href="{{route('history')}}" class="inline-block hover:text-black my-4 w-full">
                        <div class="fill-current text-gray-600 hover:text-black">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-7 h-7 material-icons-outlined float-left pr-1 mr-1" viewBox="0 0 576 512">
                                <path
                    ...
                    <a href="{{route('contact')}}" class="inline-block hover:text-black my-4 w-full">
                        <div class="fill-current text-gray-600 hover:text-black">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-7 h-6 material-icons-outlined float-left pr-1 mr-1" viewBox="0 0 448 512">
                                <path
    ...
    <script>
        ...
        // Function to handle status change when dropdown value is changed
