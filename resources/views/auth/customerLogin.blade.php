...
<div class="flex h-screen w-full items-center justify-center bg-gray-900 bg-cover bg-no-repeat" style="background-image:url('https://images.pexels.com/photos/269138/pexels-photo-269138.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')">
    <div class="rounded-xl bg-gray-800 bg-opacity-60 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
        <div class="text-white">
            <div class="mb-8 flex flex-col items-center">
                ...
                <span class="text-gray-300">Don't have an account yet?<a href="{{ route('auth.customerRegister') }}" 
            ...
            <form method="POST" action="{{ route('customerLogin') }}">
                ...
                <div class="mt-8 flex justify-center text-lg">
                    <button type="submit"
                        class="rounded-3xl bg-green-500 bg-opacity-50 px-10 py-2 text-white shadow-xl transition-colors duration-300 hover:bg-green-900">Login</button>
                </div>
            </form>
        </div>
    </div>
