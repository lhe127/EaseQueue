                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            <div class="md:col-span-5">
                                ...
                                <input type="text" name="full_name" id="full_name"
                                    class="h-10 border rounded px-4 w-full bg-gray-50" value="" />
                            </div>
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="address" id="address"
                                    class="h-10 border rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="h-10 bg-gray-50 flex border border-gray-200 rounded items-center">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="zipcode" id="zipcode"
                                    class="transition-all flex items-center h-10 border rounded px-4 w-full bg-gray-50"
                                    placeholder="" value="" />
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="h-10 w-28 bg-gray-50 flex border border-gray-200 rounded items-center">
                                    <button tabindex="-1" for="show_more"
